...
impl Model {
  ...
  /// # Errors
  ///
  /// When could not find user by the given token or DB query error ot token
  /// expired
...
impl ActiveModel {
  ...
  ///
  /// Generates a random token with a specified length and sets an expiration
  /// time for the magic link. This method is used to initiate the magic link
  /// authentication flow.
  ///
  /// # Errors
